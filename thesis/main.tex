...
% Jednym z wymagań postawionych przed autorami było przygotowanie dokumentacji przygotowanego projektu w języku angielskim. Wymóg ten wynika z międzynarodowego charakteru zespołu pracującego nad detektorem TRT. Przygotowana dokumentacja powinna spełniać następujące założenia:
% \begin{itemize}
% \item niski próg wejścia - dokumentacja powinna być napisana w taki sposób, by umożliwić osobie niezaznajomionej z dokładnym działaniem systemu GGSS szybkie jego zbudowanie i umieszczenie w środowisku produkcyjnym
% \item opis każdego z repozytoriów - 
% \end{itemize}
