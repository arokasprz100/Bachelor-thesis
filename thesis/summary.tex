...
\begin{table}[]
\centering
\caption{Statystki wkładu autorów w~projekt uzyskane za pomocą portalu GitLab}
\label{table:stats2}
\begin{tabular}{
>{\columncolor[HTML]{ECF4FF}}c |
>{\columncolor[HTML]{ECF4FF}}c |
...
>{\columncolor[HTML]{ECF4FF}}c |}
\cline{2-4}
\cellcolor[HTML]{FFFFFF}                                                  & \textbf{Ilość commit'ów} & \textbf{\begin{tabular}[c]{@{}c@{}}Ilość wykonanych \\ merge request'ów\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Ilość zamkniętych \\ issue\end{tabular}} \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}\textbf{Jarosław Cierpich}}  & 150                      & 11                                                                                    & 14                                                                          \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}\textbf{Arkadiusz Kasprzak}} & 212                      & 6                                                                                     & 12                                                                          \\ \hline
\end{tabular}
\end{table}
